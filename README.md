...
Atividades da disciplina de Padrões de Projeto — SATC.

| Atividade | Tema | Conteúdo |
|---|---|---|
| [`atividade_01_solid`](atividade_01_solid) | Princípios SOLID | Exercícios de SRP, OCP, LSP, ISP e DIP |
| [`atividade_02_singleton`](atividade_02_singleton) | Singleton | Exercícios + implementação em Java |
| [`atividade_03_Builder`](atividade_03_Builder) | Builder | Respostas + implementação em Java |
